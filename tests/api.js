...
describe('POST /login', function(done){
  it('Returnere 200, hvis brugeren kan logge ind', function(done){  user
    .post('/login')
...
it('Retunere 401, hvis brugeren ikke kan logge ind', function(done){  user
  .post('/login')
